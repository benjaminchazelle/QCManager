		...
		<div id="answer_framed" >
			<div class="padder">
					...
					if(empty($user->user_photo_path))
						echo "<a id='modaltrigger' href='#loginmodal'><div class='roundedImageedit' id='profilimgedit'>".$user->user_lastname[0]."<div id=\"pickcontrol\">Changer la photo</div></div></a>";
					else
						echo "<a id='modaltrigger' href='#loginmodal'><div class='roundedImageedit' id='profilimgedit' style=\"background-image: url($user->user_photo_path);background-size:cover;\"><div id=\"pickcontrol\">Changer la photo</div></div></a>";
					?>
